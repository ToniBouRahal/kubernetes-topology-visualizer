...
- [x] **P5-K10** Pin all images by digest — ADR-007 D-7.4 · all nine third-party images pinned by multi-arch manifest digest; `make verify-pinning` runs 16 assertions and is wired into CI. Scan and triage recorded under ADR-008 D-8.7 in `docs/evaluation/phase-5.md`.
