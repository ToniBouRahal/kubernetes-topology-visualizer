...
- [x] **P5-T18** Privacy check on committed images and text — ADR-008 D-8.7 · all five screenshots opened and inspected; committed text scanned for DSNs, inline credentials and key blocks. Two matches, both deliberate fixtures. No public-range IP anywhere in `docs/`.
